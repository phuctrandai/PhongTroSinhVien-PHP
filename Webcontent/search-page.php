...
$tuKhoa = ''; $tenQuanHuyen = ''; $tenKhuVuc = ''; $tenLoaiPhong = ''; $choTuQuan = '';
...
$MaQuanHuyen = $_REQUEST['quanHuyen'];        #var_dump($MaQuanHuyen);        echo '<br>';
$MaKhuVuc = $_REQUEST['khuVuc'];        #var_dump($MaKhuVuc);    echo '<br>';

if(isset($TuKhoa)) { $tuKhoa = $TuKhoa; }
if(isset($MaQuanHuyen) && $MaQuanHuyen != -1) {
    $quanHuyenDao = new QuanHuyenDao();
    $tenQuanHuyen = $quanHuyenDao->getTenQuanHuyen($MaQuanHuyen);
}
...
$searchResult = $baiDangDao->TimKiem($MaLoaiPhong, $ChoTuQuan, $MaQuanHuyen, $MaKhuVuc, $tuKhoa);
?>
<html>
    <head>
        <meta charset="UTF-8">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-8 col-lg-9">
                        ...
                        <h3 class="text-danger">
                            Kết quả tìm kiếm 
                            <?php if(isset($TuKhoa) && $tuKhoa != '') { echo "cho '".$tuKhoa."'"; } ?>
                        </h3>
                        <div class="">
                            <?php if($MaQuanHuyen != -1) { ?>
                            <span class="badge badge-dark">
                                Quận/huyện <?php echo($tenQuanHuyen);?>
                            </span>
                            <?php } ?>
