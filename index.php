    ...
    <body>
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <div class="single-blog-post style-2 mb-5">
                                                        ...
                                                        <div class="blog-thumbnail">
                                                            <a href="single-post.php?"><img src="img/bg-img/15.jpg" alt="<?php echo($baiDang->TieuDe); ?>"></a>
                                                        </div>

                                                        <!-- Blog Content -->
                                                        <div class="blog-content">
                                                            <span class="post-date"><?php echo($baiDang->ThoiGiagDang); ?></span>
                                                            <a href="single-post.php?" class="post-title"><?php echo($baiDang->TieuDe); ?></a>
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <div class="single-blog-post d-flex style-4 mb-30">
                                                        <!-- Blog Thumbnail -->
                                                        <div class="blog-thumbnail">
                                                            <a href="single-post.php"><img src="img/bg-img/17.jpg" alt="<?php echo($baiDang->TieuDe); ?>"></a>
                                                        </div>
        ...
        <div class="top-news-area section-padding-100">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h3 class="text-danger" style="background-color: #f0f4f8; padding: 3px 9px;">Tin trong ngày</h3>
                    </div>
                </div>
                <div class="row">
